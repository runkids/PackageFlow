...
PackageFlow 為 Nx、Turborepo、Lerna 和原生工作區等 monorepo 工具提供一流支援。

## 概覽

當您匯入專案時，會自動偵測 Monorepo。PackageFlow 識別：
...
4. **發布前檢查**：透過 PackageFlow 使用 Lerna 的版本指令
