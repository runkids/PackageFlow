...
PackageFlow 集成 npm audit 帮助您识别和修复依赖中的安全漏洞。
...
PackageFlow 运行 `npm audit` 并显示结果。

<!-- TODO: Add gif of running a security scan -->

### 自动提醒

PackageFlow 可以提醒您定期扫描：
...
某些修复可能引入破坏性变更。PackageFlow 在以下情况警告您：
...
对于 monorepo，PackageFlow 扫描每个工作区：
