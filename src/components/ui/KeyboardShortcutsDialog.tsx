/**
 * KeyboardShortcutsDialog - Professional keyboard shortcuts slide-over panel
 * Displays available keyboard shortcuts with search, category filter, and modern design
 *
 * Features:
 * - Slide-over panel from right (avoids blocking bottom UI)
  ...
  return (
    <div className={cn('fixed inset-0 z-50', 'animate-in fade-in-0 duration-200')}>
      ...
      <div
        ref={panelRef}
        className={cn(
          'fixed right-0 top-0 h-full w-[380px] max-w-[90vw]',
          'bg-background',
